    ...
    return React.createElement('div', {
        ...
        React.createElement('div', { style: { display: 'flex', gap: '6px' } },
          React.createElement('button', {
            ...
            style: {
              ...
              color: '#d4d4d4', cursor: 'pointer', fontSize: '10px', padding: '2px 8px',
            },
          }, 'Download'),
          React.createElement('button', {
      ...
      React.createElement('div', {
        style: {
          ...
          color: '#e5e7eb', borderBottom: '1px solid #333',
      ...
      React.createElement('pre', {
        style: {
          ...
          overflow: 'auto', lineHeight: 1.6, color: '#e5e7eb',
        },
      }, selected.content)
    );
  }
  ...
  return React.createElement('div', {
    ...
    React.createElement('div', {
      style: {
        padding: '8px 12px', borderBottom: '1px solid #333',
        display: 'flex', justifyContent: 'space-between', alignItems: 'center',
        fontSize: '12px', fontWeight: 600, color: '#e5e7eb', flexShrink: 0,
      },
    },
    ...
    artifacts.length === 0
      ? React.createElement('div', {
          style: { padding: '20px 12px', fontSize: '12px', color: '#6b7280', textAlign: 'center' as const },
        },
          'No files yet.',
          ...
          ...artifacts.map((artifact) =>
            React.createElement('div', {
              ...
              React.createElement('div', null,
                React.createElement('div', {
                  style: { fontSize: '12px', fontFamily: 'monospace', color: '#e5e7eb' },
                }, artifact.filename),
